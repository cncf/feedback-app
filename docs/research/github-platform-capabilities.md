...
| **Add labels to a discussion** | **Yes** | GraphQL `addLabelsToLabelable(labelableId, labelIds \| labels)` — `Discussion` implements `Labelable`; `Labelable` is implemented by `Discussion, Issue, PullRequest` | `discussions: write` — the permission is documented as covering "discussions and related comments **and labels**" | [graphql/reference/discussions](https://docs.github.com/en/graphql/reference/discussions), [graphql/reference/issues](https://docs.github.com/en/graphql/reference/issues), [rest/apps/apps](https://docs.github.com/en/rest/apps/apps) |
| Remove / clear labels on a discussion | Yes | GraphQL `removeLabelsFromLabelable`, `clearLabelsFromLabelable` | `discussions: write` | [graphql/reference/issues](https://docs.github.com/en/graphql/reference/issues) |
